...
The tests have been extended to 50 random matrices to check whether the initial check was a one time result.
I have also made it possible to alter the size of the matrix subject to the tests through the Makefile.
