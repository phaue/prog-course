...
class main{
	...
	Write($"a>1  ? {a>1}\n");
	Write($"b>1  ? {b>1}\n");
	Write("1+tiny+tiny is therefore not larger than one and tiny+tiny+1 is. This is because two doubles in a finite digit representation can only be compared with the given absolute and/or relative precision\n");
